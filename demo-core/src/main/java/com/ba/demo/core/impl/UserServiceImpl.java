...
public class UserServiceImpl implements UserService {
    ...
    private void sendRegistrationEmail(String email, UUID activationToken, int language, String callbackUrl) {
        String subject = internationalizatonService.getByLanguageId(language,"email_verification_subject");
        String content = internationalizatonService.getByLanguageId(language,"email_verification_body_web");
        ...
        Map<String, Object> params = ImmutableMap.of("title", subject,
                "body", content, "url", callbackUrl + activationToken.toString()
                , "buttonText", buttonText);
        this.emailService.sendNotification(email, subject, "templates/email/confirmation.code.html", params);
    }
}
