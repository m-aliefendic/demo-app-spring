...
public class MessagesKey {
  ...
  public static final MessagesKey username_already_exists =
      new MessagesKey("username_already_exists", 0);
  ...
  public static final MessagesKey require_authentication =
      new MessagesKey("require_authentication", 0);
