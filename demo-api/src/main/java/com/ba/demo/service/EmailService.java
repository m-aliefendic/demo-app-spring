...
public class EmailService {
    ...
    public void sendNotification(String to, String subject, String template, Map<String, Object> immutableMap) {
        LOGGER.info("Sending notification by email to : {} , subject: {}, template: {}, params : {}", to, subject, template, immutableMap);
        try {
