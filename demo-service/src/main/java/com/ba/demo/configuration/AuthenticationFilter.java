...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    , ObjectMapper objectMapper, InternationalizatonService internationalizatonService) {
    ...
    protected void doFilterInternal(final HttpServletRequest httpRequest, final HttpServletResponse httpResponse, final FilterChain filterChain) throws ServletException, IOException {
        try {
            ...
            String token = Optional.ofNullable(httpRequest.getHeader(HttpHeaders.AUTHORIZATION))
                    ...
                    .orElseThrow(() -> new SpecificException(ErrorCode.UNAUTHORIZED, MessagesKey.require_authentication));
    ...
    private void writeErrorResponse(HttpServletResponse response, ErrorCode errorCode, MessagesKey messageKey, Object... messageTokens) {
